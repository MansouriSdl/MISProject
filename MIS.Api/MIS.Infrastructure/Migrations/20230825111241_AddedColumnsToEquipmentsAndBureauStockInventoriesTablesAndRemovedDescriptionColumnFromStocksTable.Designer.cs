...
namespace MIS.Infrastructure.Migrations
{
    ...
    [Migration("20230825111241_AddedColumnsToEquipmentsAndBureauStockInventoriesTablesAndRemovedDescriptionColumnFromStocksTable")]
    partial class AddedColumnsToEquipmentsAndBureauStockInventoriesTablesAndRemovedDescriptionColumnFromStocksTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MIS.Domain.Entities.DivisionEquipmentRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DivisionEquipmentRequests");
                });
            ...
            modelBuilder.Entity("MIS.Domain.Entities.DivisionEquipmentRequest", b =>
                {
                    b.HasOne("MIS.Domain.Entities.Division", "Division")
                        .WithMany("DivisionEquipmentRequests")
                    ...
                    b.HasOne("MIS.Domain.Entities.Order", "Order")
                        .WithOne("DivisionEquipmentRequest")
                        .HasForeignKey("MIS.Domain.Entities.DivisionEquipmentRequest", "OrderId");
            ...
            modelBuilder.Entity("MIS.Domain.Entities.Division", b =>
                {
                    b.Navigation("DivisionEquipmentRequests");
            ...
            modelBuilder.Entity("MIS.Domain.Entities.Order", b =>
                {
                    b.Navigation("DivisionEquipmentRequest");
                });
